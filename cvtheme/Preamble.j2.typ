...
#let cv-accent-soft = rgb(159, 196, 232)
#let cv-rule-soft = rgb(200, 216, 232)
...
#show heading.where(level: 2): it => [
  ...
  #block(
    ...
    [
        ...
        #box(
          [
            #box(width: 0.18cm, height: 0.18cm, fill: cv-accent-soft, radius: 0.04cm)
            #h(0.18cm)
            #section-title
...
#let connections(connections-list) = context {
  ...
  v(0.24cm)
  box(width: 100%, height: 0.55pt, fill: cv-rule-soft)
